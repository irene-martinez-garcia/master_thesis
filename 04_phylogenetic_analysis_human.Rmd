# Phylogenetic Analysis (HUMAN)

### Load data
```{r load data phylogenetics_human}
...
```{r check tree_human, fig.height=8, fig.width=16, fig.fullwidth=TRUE}
...
```{r remove low size mag_human, fig.height=8, fig.width=10, fig.fullwidth=TRUE}
...
```{r genome_phylogeny_completeness_human, message=FALSE, warning=FALSE, fig.height=7, fig.width=7, fig.fullwidth=TRUE}
# Generate  basal tree
...
```{r genome_phylogeny_plot_human, message=FALSE, warning=FALSE, fig.height=7, fig.width=7, fig.fullwidth=TRUE}
# Generate  basal tree
