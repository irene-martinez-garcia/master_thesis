...
# Plot with CORRECT variance labels
...
```{r adjust kegg matrix by genome size}
...
```{r testing gifts between clusters}
...
```{r testing gifts between clusters pairwise}
...
```{r sig_cluster_gift_plot, fig.height=10, fig.width=8, fig.fullwidth=TRUE}
library(reshape2)
library(RColorBrewer)
...
```{r testing gifts between sources pairwise}
