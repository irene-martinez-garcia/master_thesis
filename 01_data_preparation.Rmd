...
#new - gene-level annotations only:
drakkar annotating -b /maps/projects/alberdilab/people/pjq449/comparative_metagenomics/data/bacteroides_uniformis/mags/unzipped -o /maps/projects/alberdilab/people/pjq449/comparative_metagenomics/data/bacteroides_uniformis --env_path /projects/alberdilab/data/environments/drakkar --annotation-type genes 
```
...
```{bash, eval = FALSE}
snakemake \
  --snakefile /maps/projects/alberdilab/people/pjq449/comparative_metagenomics/snakefiles/ppanggolin.smk \
  --configfile /maps/projects/alberdilab/people/pjq449/comparative_metagenomics/snakefiles/pangolin_config.yaml \
  --executor slurm \
  --jobs 10 \
  --latency-wait 60 \
  --printshellcmds
